...
# Factions before this point are hardwired into the game end their order should not be changed.
  ...
  # WARBAND CULTURES MOD: Player custom culture factions
  ("culture_7",  "{!}Player Culture 1", 0, 0.9, [], []),  # First player custom culture
  ("culture_8",  "{!}Player Culture 2", 0, 0.9, [], []),  # Second player custom culture
  ("culture_9",  "{!}Player Culture 3", 0, 0.9, [], []),  # Third player custom culture
  ("culture_10", "{!}Player Culture 4", 0, 0.9, [], []),  # Fourth player custom culture
