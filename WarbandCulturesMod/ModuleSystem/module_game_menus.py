...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
     ...
     ("configure_cultures",[],"Configure Cultures (Warband Cultures Mod)...",
...
##  ),
  ...
  (
    ...
    [
      ...
      # WARBAND CULTURES MOD: View settlement cultures option (villages)
      ("wc_view_village_cultures",
       [
           # Always available - shows culture breakdown for this village
        ],
         "View settlement cultures.",
         [
           (call_script, "script_wc_display_center_cultures", "$current_town"),
          ]),
...
#			(troop_slot_eq, ":lady_guardian", slot_lord_granted_courtship_permission, -1),
	...
	(gt, "$love_interest_in_town", 0),
      ...
      # WARBAND CULTURES MOD: View settlement cultures option
      ("wc_view_cultures",
       [
           # Always available - shows culture breakdown for this settlement
        ],
         "View settlement cultures.",
         [
           (call_script, "script_wc_display_center_cultures", "$current_town"),
