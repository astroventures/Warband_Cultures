...
########################################################
##  WARBAND CULTURES MOD - FACTION SLOTS  ##############
########################################################
# Template troop allocation tracking (200-229)
# Each culture faction gets 10 template troops
# These slots track next available template per culture

wc_slot_faction_template_next_idx     = 200  # Next available template index (0-9) for this culture
wc_slot_faction_template_count        = 201  # Total templates allocated to this culture
wc_slot_faction_custom_tier_1_troop   = 202  # Custom tier 1 troop for this culture
wc_slot_faction_custom_tier_2_troop   = 203  # Custom tier 2 troop
wc_slot_faction_custom_tier_3_troop   = 204  # Custom tier 3 troop
wc_slot_faction_custom_tier_4_troop   = 205  # Custom tier 4 troop
wc_slot_faction_custom_tier_5_troop   = 206  # Custom tier 5 troop
wc_slot_faction_tree_fork_total       = 207  # Total forks used in this culture's unit tree
wc_slot_faction_unit_tree_configured  = 208  # 1 if culture has a custom unit tree defined
wc_slot_faction_name_string           = 209  # String ID for culture name
wc_slot_faction_title_king            = 210  # String ID for king/ruler title
wc_slot_faction_title_lord            = 211  # String ID for lord title

# Template troop ranges per culture (constants, not slots)
wc_templates_per_culture = 10
wc_template_culture_1_begin = 0    # Culture 1 (Swadian) templates 0-9
wc_template_culture_2_begin = 10   # Culture 2 (Vaegir) templates 10-19
wc_template_culture_3_begin = 20   # Culture 3 (Khergit) templates 20-29
wc_template_culture_4_begin = 30   # Culture 4 (Nord) templates 30-39
wc_template_culture_5_begin = 40   # Culture 5 (Rhodok) templates 40-49
wc_template_culture_6_begin = 50   # Culture 6 (Sarranid) templates 50-59
wc_template_culture_7_begin = 60   # Player Culture 1 templates 60-69
wc_template_culture_8_begin = 70   # Player Culture 2 templates 70-79
wc_template_culture_9_begin = 80   # Player Culture 3 templates 80-89
wc_template_culture_10_begin = 90  # Player Culture 4 templates 90-99
wc_template_total_count = 100      # Total template troops

# Fork constraints
wc_max_forks_per_unit = 2          # Max upgrade paths per single unit
wc_max_forks_per_tree = 4          # Max total forks in entire unit tree
...
########################################################
##  WARBAND CULTURES MOD - SETTLEMENT CULTURE SLOTS  ###
########################################################
# Each settlement stores percentage of each culture (0-100)
# Total should sum to 100

wc_slot_center_culture_pct_1   = 400  # Swadian culture %
wc_slot_center_culture_pct_2   = 401  # Vaegir culture %
wc_slot_center_culture_pct_3   = 402  # Khergit culture %
wc_slot_center_culture_pct_4   = 403  # Nord culture %
wc_slot_center_culture_pct_5   = 404  # Rhodok culture %
wc_slot_center_culture_pct_6   = 405  # Sarranid culture %
wc_slot_center_culture_pct_7   = 406  # Player custom culture 1
wc_slot_center_culture_pct_8   = 407  # Player custom culture 2
wc_slot_center_culture_pct_9   = 408  # Player custom culture 3
wc_slot_center_culture_pct_10  = 409  # Player custom culture 4

# Culture shift tracking
wc_slot_center_culture_shift_rate  = 410  # How fast culture changes (modified by population)
wc_slot_center_last_culture_update = 411  # Game hour of last culture calculation
wc_slot_center_population_density  = 412  # Affects culture inertia

wc_center_culture_slots_begin  = 400
wc_center_culture_slots_end    = 413
########################################################
...
########################################################
##  WARBAND CULTURES MOD - CUSTOM TROOP SLOTS  #########
########################################################
# Slots 300+ reserved for dynamic unit system
# Note: Slots 165-290 used for lord relations - keep clear

# Unit Definition Slots (300-349)
wc_slot_troop_is_custom        = 300  # 1 if this is a player-defined troop
wc_slot_troop_culture          = 301  # Which player culture this belongs to
wc_slot_troop_tier             = 302  # Unit tier (1-5)
wc_slot_troop_is_mounted       = 303  # 1 if cavalry unit
wc_slot_troop_base_strength    = 304  # Base STR stat
wc_slot_troop_base_agility     = 305  # Base AGI stat
wc_slot_troop_base_intelligence = 306 # Base INT stat (usually 4)
wc_slot_troop_base_charisma    = 307  # Base CHA stat (usually 4)

# Skill Slots (310-329)
wc_slot_troop_skill_ironflesh   = 310
wc_slot_troop_skill_powerstrike = 311
wc_slot_troop_skill_powerdraw   = 312
wc_slot_troop_skill_powerthrow  = 313
wc_slot_troop_skill_riding      = 314
wc_slot_troop_skill_athletics   = 315
wc_slot_troop_skill_shield      = 316
wc_slot_troop_skill_weaponmaster = 317
wc_slot_troop_skill_horsearchery = 318

# Equipment Cost Tracking (330-339)
wc_slot_troop_total_equip_cost = 330  # Sum of all equipment base costs
wc_slot_troop_maintenance_cost = 331  # Weekly maintenance (derived from equip cost)
wc_slot_troop_upgrade_cost     = 332  # Cost to upgrade to this unit

# Upgrade Tree Slots (340-349)
wc_slot_troop_upgrades_to_1    = 340  # First upgrade option (troop ID or 0)
wc_slot_troop_upgrades_to_2    = 341  # Second upgrade option (troop ID or 0)
wc_slot_troop_upgrades_from    = 342  # Which troop this upgrades from
wc_slot_troop_fork_count       = 343  # Number of upgrade paths (0, 1, or 2)
wc_slot_troop_tree_fork_total  = 344  # Total forks in this unit's entire tree
wc_slot_troop_tree_root        = 345  # Reference to tier 1 unit in this tree
wc_slot_troop_tree_depth       = 346  # How many tiers from root (0 = tier 1 recruit)

# Unit Equipment Slots (350-399) - Store item IDs
# Head, Body, Foot, Gloves slots (each can have up to 4 variants)
wc_slot_troop_head_1           = 350
wc_slot_troop_head_2           = 351
wc_slot_troop_head_3           = 352
wc_slot_troop_head_4           = 353
wc_slot_troop_body_1           = 354
wc_slot_troop_body_2           = 355
wc_slot_troop_body_3           = 356
wc_slot_troop_body_4           = 357
wc_slot_troop_foot_1           = 358
wc_slot_troop_foot_2           = 359
wc_slot_troop_foot_3           = 360
wc_slot_troop_foot_4           = 361
wc_slot_troop_gloves_1         = 362
wc_slot_troop_gloves_2         = 363
wc_slot_troop_gloves_3         = 364
wc_slot_troop_gloves_4         = 365

# Weapon loadout slots (3 loadouts x 4 weapon slots)
wc_slot_troop_loadout1_weapon1 = 370
wc_slot_troop_loadout1_weapon2 = 371
wc_slot_troop_loadout1_weapon3 = 372
wc_slot_troop_loadout1_weapon4 = 373
wc_slot_troop_loadout2_weapon1 = 374
wc_slot_troop_loadout2_weapon2 = 375
wc_slot_troop_loadout2_weapon3 = 376
wc_slot_troop_loadout2_weapon4 = 377
wc_slot_troop_loadout3_weapon1 = 378
wc_slot_troop_loadout3_weapon2 = 379
wc_slot_troop_loadout3_weapon3 = 380
wc_slot_troop_loadout3_weapon4 = 381

# Horse slots (for mounted units)
wc_slot_troop_horse_1          = 385
wc_slot_troop_horse_2          = 386
wc_slot_troop_horse_3          = 387

# Proficiency Slots (390-395) - weapon skill levels
wc_slot_troop_prof_onehanded   = 390
wc_slot_troop_prof_twohanded   = 391
wc_slot_troop_prof_polearm     = 392
wc_slot_troop_prof_archery     = 393
wc_slot_troop_prof_crossbow    = 394
wc_slot_troop_prof_throwing    = 395

# Display and naming (396-399)
wc_slot_troop_display_name_str = 396  # String ID for dynamic display name
wc_slot_troop_name_type        = 397  # Unit type suffix (0=Recruit, 1=Footman, etc.)
wc_slot_troop_is_configured    = 398  # 1 if unit has been fully configured
wc_slot_troop_variant_mask     = 399  # Bitmask for equipment variant selection

# Slot range markers
wc_custom_troop_slots_begin    = 300
wc_custom_troop_slots_end      = 400

# Equipment Browser constants
wc_equip_type_head             = 0
wc_equip_type_body             = 1
wc_equip_type_foot             = 2
wc_equip_type_hand             = 3
wc_equip_type_weapon           = 4  # Any weapon type
wc_equip_type_horse            = 5

wc_equip_items_per_page        = 8  # Items shown per page in browser

# Item type constants (from header_items.py for convenience)
wc_itp_type_horse              = 0x0000000000000001
wc_itp_type_one_handed         = 0x0000000000000002
wc_itp_type_two_handed         = 0x0000000000000003
wc_itp_type_polearm            = 0x0000000000000004
wc_itp_type_arrows             = 0x0000000000000005
wc_itp_type_bolts              = 0x0000000000000006
wc_itp_type_shield             = 0x0000000000000007
wc_itp_type_bow                = 0x0000000000000008
wc_itp_type_crossbow           = 0x0000000000000009
wc_itp_type_thrown             = 0x000000000000000a
wc_itp_type_goods              = 0x000000000000000b
wc_itp_type_head_armor         = 0x000000000000000c
wc_itp_type_body_armor         = 0x000000000000000d
wc_itp_type_foot_armor         = 0x000000000000000e
wc_itp_type_hand_armor         = 0x000000000000000f
wc_itp_type_pistol             = 0x0000000000000010
wc_itp_type_musket             = 0x0000000000000011
wc_itp_type_bullets            = 0x0000000000000012
wc_itp_type_animal             = 0x0000000000000013
wc_itp_type_book               = 0x0000000000000014

# Loadout Builder constants
# Each unit has 3 loadouts, each loadout has 4 weapon slots
wc_max_loadouts_per_unit       = 3
wc_slots_per_loadout           = 4

# Unit class constants (affects equipment restrictions)
wc_unit_class_infantry         = 0   # Melee foot soldiers - NO bows/crossbows
wc_unit_class_archer           = 1   # Ranged foot soldiers - bows/crossbows allowed
wc_unit_class_cavalry          = 2   # Mounted melee - NO bows/crossbows
wc_unit_class_horse_archer     = 3   # Mounted ranged - bows allowed

# Tier-gating thresholds (based on vanilla troop analysis)
# Max equipment cost allowed per tier
wc_tier_1_max_armor_cost       = 300    # Basic cloth/leather
wc_tier_2_max_armor_cost       = 1000   # Padded/mail shirt
wc_tier_3_max_armor_cost       = 2500   # Mail hauberk/brigandine
wc_tier_4_max_armor_cost       = 5000   # Banded/early plate
wc_tier_5_max_armor_cost       = 99999  # All equipment

# Max body armor value per tier
wc_tier_1_max_body_armor       = 25
wc_tier_2_max_body_armor       = 42
wc_tier_3_max_body_armor       = 50
wc_tier_4_max_body_armor       = 55
wc_tier_5_max_body_armor       = 99

# Max horse cost per tier (for mounted units)
wc_tier_1_max_horse_cost       = 250    # Saddle horse only
wc_tier_2_max_horse_cost       = 650    # Courser
wc_tier_3_max_horse_cost       = 900    # Hunter
wc_tier_4_max_horse_cost       = 1500   # Warhorse
wc_tier_5_max_horse_cost       = 99999  # All horses

# Max weapon cost per tier
wc_tier_1_max_weapon_cost      = 150    # Basic swords/spears
wc_tier_2_max_weapon_cost      = 400    # Good swords/axes
wc_tier_3_max_weapon_cost      = 800    # Quality weapons
wc_tier_4_max_weapon_cost      = 1500   # Elite weapons
wc_tier_5_max_weapon_cost      = 99999  # All weapons
