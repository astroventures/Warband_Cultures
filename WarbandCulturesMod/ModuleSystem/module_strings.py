...
("the_coast", "the coast"),
  ...
  # WARBAND CULTURES MOD - Test strings for prototype presentation
  ("wc_test_title", "Warband Cultures - UI Prototype"),
  ("wc_test_stat_strength", "Strength:"),
  ("wc_test_stat_agility", "Agility:"),
  ("wc_test_stat_intelligence", "Intelligence:"),
  ("wc_test_stat_charisma", "Charisma:"),
  ("wc_test_points_remaining", "Points Remaining: {reg0}"),
  ("wc_test_unit_type", "Unit Type:"),
  ("wc_test_tier_level", "Tier Level: {reg0}"),
  ("wc_test_btn_confirm", "Confirm"),
  ("wc_test_btn_cancel", "Cancel"),
  ("wc_test_btn_reset", "Reset"),
  ("wc_test_mounted", "Mounted"),
  ("wc_test_infantry", "Infantry"),
  ("wc_test_archer", "Archer"),
  ("wc_test_equipment_slot", "Equipment Slot {reg0}:"),
  ("wc_test_success", "Prototype test successful!"),

  # EPIC 2: CULTURE SYSTEM STRINGS
  ("wc_culture_title", "Settlement Culture"),
  ("wc_culture_swadian", "Swadian: {reg0}%"),
  ("wc_culture_vaegir", "Vaegir: {reg0}%"),
  ("wc_culture_khergit", "Khergit: {reg0}%"),
  ("wc_culture_nord", "Nord: {reg0}%"),
  ("wc_culture_rhodok", "Rhodok: {reg0}%"),
  ("wc_culture_sarranid", "Sarranid: {reg0}%"),
  ("wc_culture_custom_1", "Custom 1: {reg0}%"),
  ("wc_culture_custom_2", "Custom 2: {reg0}%"),
  ("wc_culture_custom_3", "Custom 3: {reg0}%"),
  ("wc_culture_custom_4", "Custom 4: {reg0}%"),
  ("wc_view_cultures", "View settlement cultures"),
  ("wc_culture_header", "{s1} Culture Breakdown"),
  ("wc_culture_shift_info", "Culture shifting toward {s2} ({reg1}% per day)"),
  # END WARBAND CULTURES MOD STRINGS
