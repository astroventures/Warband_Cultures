...
##        (gt, ":total_wage", 0),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    # WARBAND CULTURES MOD - Prototype Presentation for UI Testing
    # Tests: text overlays, buttons, sliders, number boxes, combo boxes, containers
    ("wc_unit_creator_prototype", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        # Initialize test variables
        (assign, "$wc_test_strength", 10),
        (assign, "$wc_test_agility", 10),
        (assign, "$wc_test_points", 20),
        (assign, "$wc_test_unit_type", 0),  # 0=Infantry, 1=Archer, 2=Mounted
        (assign, "$wc_test_tier", 1),

        # Set up screen layout - 1000x750 virtual coordinates
        (set_fixed_point_multiplier, 1000),

        # Title text at top
        (create_text_overlay, reg0, "str_wc_test_title", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 700),
        (overlay_set_position, reg0, pos1),
        (position_set_x, pos1, 1500),
        ...
        # Section 1: Stat Sliders (left side)
        # Strength label + slider
        (create_text_overlay, reg0, "str_wc_test_stat_strength", 0),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg0, pos1),

        (create_slider_overlay, "$wc_test_str_slider", 1, 30),
        (overlay_set_val, "$wc_test_str_slider", "$wc_test_strength"),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 600),
        (overlay_set_position, "$wc_test_str_slider", pos1),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_test_str_slider", pos1),

        (assign, reg0, "$wc_test_strength"),
        (create_text_overlay, "$wc_test_str_label", "@{reg0}", 0),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 600),
        (overlay_set_position, "$wc_test_str_label", pos1),

        # Agility label + slider
        (create_text_overlay, reg0, "str_wc_test_stat_agility", 0),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 550),
        (overlay_set_position, reg0, pos1),

        (create_slider_overlay, "$wc_test_agi_slider", 1, 30),
        (overlay_set_val, "$wc_test_agi_slider", "$wc_test_agility"),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 550),
        (overlay_set_position, "$wc_test_agi_slider", pos1),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_test_agi_slider", pos1),

        (assign, reg0, "$wc_test_agility"),
        (create_text_overlay, "$wc_test_agi_label", "@{reg0}", 0),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 550),
        (overlay_set_position, "$wc_test_agi_label", pos1),

        # Points remaining display
        (assign, reg0, "$wc_test_points"),
        (create_text_overlay, "$wc_test_points_label", "str_wc_test_points_remaining", 0),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 480),
        (overlay_set_position, "$wc_test_points_label", pos1),

        # Section 2: Combo box for unit type (right side)
        (create_text_overlay, reg0, "str_wc_test_unit_type", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg0, pos1),

        (create_combo_button_overlay, "$wc_test_type_combo"),
        (overlay_add_item, "$wc_test_type_combo", "str_wc_test_infantry"),
        (overlay_add_item, "$wc_test_type_combo", "str_wc_test_archer"),
        (overlay_add_item, "$wc_test_type_combo", "str_wc_test_mounted"),
        (overlay_set_val, "$wc_test_type_combo", "$wc_test_unit_type"),
        (position_set_x, pos1, 650),
        (position_set_y, pos1, 600),
        (overlay_set_position, "$wc_test_type_combo", pos1),

        # Section 3: Number box for tier
        (assign, reg0, "$wc_test_tier"),
        (create_text_overlay, reg0, "str_wc_test_tier_level", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 540),
        (overlay_set_position, reg0, pos1),

        (create_number_box_overlay, "$wc_test_tier_box", 1, 6),
        (overlay_set_val, "$wc_test_tier_box", "$wc_test_tier"),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 540),
        (overlay_set_position, "$wc_test_tier_box", pos1),

        # Section 4: Buttons at bottom
        (create_button_overlay, "$wc_test_btn_confirm", "str_wc_test_btn_confirm", tf_center_justify),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_test_btn_confirm", pos1),

        (create_button_overlay, "$wc_test_btn_cancel", "str_wc_test_btn_cancel", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_test_btn_cancel", pos1),

        (create_button_overlay, "$wc_test_btn_reset", "str_wc_test_btn_reset", tf_center_justify),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_test_btn_reset", pos1),
      ...
      (ti_on_presentation_event_state_change, [
        ...
        (try_begin),
          # Strength slider changed
          (eq, ":object", "$wc_test_str_slider"),
          (assign, "$wc_test_strength", ":value"),
          (assign, reg0, ":value"),
          (overlay_set_text, "$wc_test_str_label", "@{reg0}"),
          # Update points
          (store_sub, ":used", "$wc_test_strength", 10),
          (store_sub, ":used2", "$wc_test_agility", 10),
          (val_add, ":used", ":used2"),
          (store_sub, "$wc_test_points", 20, ":used"),
          (assign, reg0, "$wc_test_points"),
          (overlay_set_text, "$wc_test_points_label", "str_wc_test_points_remaining"),
        (else_try),
          # Agility slider changed
          (eq, ":object", "$wc_test_agi_slider"),
          (assign, "$wc_test_agility", ":value"),
          (assign, reg0, ":value"),
          (overlay_set_text, "$wc_test_agi_label", "@{reg0}"),
          # Update points
          (store_sub, ":used", "$wc_test_strength", 10),
          (store_sub, ":used2", "$wc_test_agility", 10),
          (val_add, ":used", ":used2"),
          ...
          (overlay_set_text, "$wc_test_points_label", "str_wc_test_points_remaining"),
        (else_try),
          # Unit type combo changed
          (eq, ":object", "$wc_test_type_combo"),
          (assign, "$wc_test_unit_type", ":value"),
        (else_try),
          # Tier number box changed
          (eq, ":object", "$wc_test_tier_box"),
          (assign, "$wc_test_tier", ":value"),
        (else_try),
          # Confirm button clicked
          (eq, ":object", "$wc_test_btn_confirm"),
          (display_message, "str_wc_test_success"),
          (presentation_set_duration, 0),
        (else_try),
          # Cancel button clicked
          (eq, ":object", "$wc_test_btn_cancel"),
          (presentation_set_duration, 0),
        (else_try),
          # Reset button clicked
          (eq, ":object", "$wc_test_btn_reset"),
          (assign, "$wc_test_strength", 10),
          (assign, "$wc_test_agility", 10),
          (assign, "$wc_test_points", 20),
          (assign, "$wc_test_unit_type", 0),
          (assign, "$wc_test_tier", 1),
          # Restart presentation to refresh
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator_prototype"),
        (try_end),
      ]),
    ]),
    # END WARBAND CULTURES MOD PROTOTYPE

    ########################################################
    ##  WARBAND CULTURES MOD - UNIT CREATOR PRESENTATION  ##
    ########################################################
    # Full unit creation UI for configuring custom troops
    # Uses global vars: $wc_creator_tier, $wc_creator_culture, etc.
    ("wc_unit_creator", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        # Initialize upgrade context if not set (not in upgrade mode)
        (try_begin),
          (neg|is_between, "$wc_upgrade_target_troop", "trp_wc_template_001", "trp_wc_template_100"),
          (assign, "$wc_upgrade_source_troop", -1),
          (assign, "$wc_upgrade_target_troop", -1),
        (try_end),

        # Get tier constraints
        (try_begin),
          (le, "$wc_creator_tier", 0),
          (assign, "$wc_creator_tier", 1),
        (try_end),

        (try_begin),
          (eq, "$wc_creator_tier", 1),
          (assign, "$wc_creator_max_stat_points", 16),
          (assign, "$wc_creator_max_skill_points", 6),
          (assign, "$wc_creator_prof_base", 60),
        (else_try),
          (eq, "$wc_creator_tier", 2),
          (assign, "$wc_creator_max_stat_points", 20),
          (assign, "$wc_creator_max_skill_points", 10),
          (assign, "$wc_creator_prof_base", 75),
        (else_try),
          (eq, "$wc_creator_tier", 3),
          (assign, "$wc_creator_max_stat_points", 24),
          (assign, "$wc_creator_max_skill_points", 16),
          (assign, "$wc_creator_prof_base", 90),
        (else_try),
          (eq, "$wc_creator_tier", 4),
          (assign, "$wc_creator_max_stat_points", 28),
          (assign, "$wc_creator_max_skill_points", 24),
          (assign, "$wc_creator_prof_base", 110),
        (else_try),
          (assign, "$wc_creator_max_stat_points", 32),
          (assign, "$wc_creator_max_skill_points", 32),
          (assign, "$wc_creator_prof_base", 135),
        (try_end),

        # Initialize stats if not set
        (try_begin),
          (le, "$wc_creator_str", 0),
          (assign, "$wc_creator_str", 7),
          (assign, "$wc_creator_agi", 5),
          (assign, "$wc_creator_int", 4),
          (assign, "$wc_creator_cha", 4),
          (assign, "$wc_creator_skill_ironflesh", 0),
          (assign, "$wc_creator_skill_powerstrike", 0),
          (assign, "$wc_creator_skill_athletics", 0),
          (assign, "$wc_creator_skill_shield", 0),
          (assign, "$wc_creator_skill_riding", 0),
          (assign, "$wc_creator_skill_powerdraw", 0),
          (assign, "$wc_creator_skill_powerthrow", 0),
          (assign, "$wc_creator_skill_weaponmaster", 0),
          (assign, "$wc_creator_prof_1h", "$wc_creator_prof_base"),
          (assign, "$wc_creator_prof_2h", "$wc_creator_prof_base"),
          (assign, "$wc_creator_prof_pole", "$wc_creator_prof_base"),
          (assign, "$wc_creator_prof_archery", "$wc_creator_prof_base"),
          (assign, "$wc_creator_prof_xbow", "$wc_creator_prof_base"),
          (assign, "$wc_creator_prof_throw", "$wc_creator_prof_base"),
          # Initialize equipment selections
          (assign, "$wc_selected_head", -1),
          (assign, "$wc_selected_body", -1),
          (assign, "$wc_selected_foot", -1),
          (assign, "$wc_selected_hand", -1),
          (assign, "$wc_selected_horse", -1),
          # Initialize loadout slots
          (assign, "$wc_loadout1_slot1", -1),
          (assign, "$wc_loadout1_slot2", -1),
          (assign, "$wc_loadout1_slot3", -1),
          (assign, "$wc_loadout1_slot4", -1),
          (assign, "$wc_loadout2_slot1", -1),
          (assign, "$wc_loadout2_slot2", -1),
          (assign, "$wc_loadout2_slot3", -1),
          (assign, "$wc_loadout2_slot4", -1),
          (assign, "$wc_loadout3_slot1", -1),
          (assign, "$wc_loadout3_slot2", -1),
          (assign, "$wc_loadout3_slot3", -1),
          (assign, "$wc_loadout3_slot4", -1),
          # Initialize class, name type, and culture
          (assign, "$wc_creator_class", 0),
          (assign, "$wc_creator_unit_name_type", 0),
          # Culture should be set before opening unit creator, default to player faction culture
          (try_begin),
            (le, "$wc_creator_culture", 0),
        ...
        # Title
        (assign, reg0, "$wc_creator_tier"),
        (create_text_overlay, reg1, "@Create Unit - Tier {reg0}", tf_center_justify),
        (position_set_x, pos1, 500),
        ...
        # Mounted checkbox
        (create_check_box_overlay, "$wc_creator_mounted_check", "mesh_checkbox_off", "mesh_checkbox_on"),
        (overlay_set_val, "$wc_creator_mounted_check", "$wc_creator_is_mounted"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 665),
        (overlay_set_position, "$wc_creator_mounted_check", pos1),
        (create_text_overlay, reg0, "@Mounted Unit", 0),
        (position_set_x, pos1, 130),
        (position_set_y, pos1, 665),
        (overlay_set_position, reg0, pos1),

        # STATS header
        (store_add, ":stat_used", "$wc_creator_str", "$wc_creator_agi"),
        (val_add, ":stat_used", "$wc_creator_int"),
        (val_add, ":stat_used", "$wc_creator_cha"),
        (store_sub, "$wc_creator_stat_remaining", "$wc_creator_max_stat_points", ":stat_used"),
        (val_add, "$wc_creator_stat_remaining", 20),
        (assign, reg0, "$wc_creator_stat_remaining"),
        (create_text_overlay, "$wc_creator_stat_remaining_label", "@STATS (Pts: {reg0})", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 620),
        (overlay_set_position, "$wc_creator_stat_remaining_label", pos1),
        (overlay_set_color, "$wc_creator_stat_remaining_label", 0xFFDD00),

        # STR slider
        (create_text_overlay, reg0, "@STR:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_str_slider", 3, 30),
        (overlay_set_val, "$wc_creator_str_slider", "$wc_creator_str"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 580),
        (overlay_set_position, "$wc_creator_str_slider", pos1),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_str_slider", pos1),
        (assign, reg0, "$wc_creator_str"),
        (create_text_overlay, "$wc_creator_str_label", "@{reg0}", 0),
        (position_set_x, pos1, 230),
        (position_set_y, pos1, 580),
        (overlay_set_position, "$wc_creator_str_label", pos1),

        # AGI slider
        (create_text_overlay, reg0, "@AGI:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_agi_slider", 3, 30),
        (overlay_set_val, "$wc_creator_agi_slider", "$wc_creator_agi"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_creator_agi_slider", pos1),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_agi_slider", pos1),
        (assign, reg0, "$wc_creator_agi"),
        (create_text_overlay, "$wc_creator_agi_label", "@{reg0}", 0),
        (position_set_x, pos1, 230),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_creator_agi_label", pos1),

        # INT slider
        (create_text_overlay, reg0, "@INT:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 510),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_int_slider", 3, 30),
        (overlay_set_val, "$wc_creator_int_slider", "$wc_creator_int"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 510),
        (overlay_set_position, "$wc_creator_int_slider", pos1),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_int_slider", pos1),
        (assign, reg0, "$wc_creator_int"),
        (create_text_overlay, "$wc_creator_int_label", "@{reg0}", 0),
        (position_set_x, pos1, 230),
        (position_set_y, pos1, 510),
        (overlay_set_position, "$wc_creator_int_label", pos1),

        # CHA slider
        (create_text_overlay, reg0, "@CHA:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 475),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_cha_slider", 3, 30),
        (overlay_set_val, "$wc_creator_cha_slider", "$wc_creator_cha"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 475),
        (overlay_set_position, "$wc_creator_cha_slider", pos1),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_cha_slider", pos1),
        (assign, reg0, "$wc_creator_cha"),
        (create_text_overlay, "$wc_creator_cha_label", "@{reg0}", 0),
        (position_set_x, pos1, 230),
        (position_set_y, pos1, 475),
        (overlay_set_position, "$wc_creator_cha_label", pos1),

        # SKILLS header
        (store_add, ":skill_used", "$wc_creator_skill_ironflesh", "$wc_creator_skill_powerstrike"),
        (val_add, ":skill_used", "$wc_creator_skill_athletics"),
        (val_add, ":skill_used", "$wc_creator_skill_shield"),
        (val_add, ":skill_used", "$wc_creator_skill_riding"),
        (val_add, ":skill_used", "$wc_creator_skill_powerdraw"),
        (val_add, ":skill_used", "$wc_creator_skill_powerthrow"),
        (val_add, ":skill_used", "$wc_creator_skill_weaponmaster"),
        (store_sub, "$wc_creator_skill_remaining", "$wc_creator_max_skill_points", ":skill_used"),
        (assign, reg0, "$wc_creator_skill_remaining"),
        (create_text_overlay, "$wc_creator_skill_remaining_label", "@SKILLS (Pts: {reg0})", 0),
        (position_set_x, pos1, 280),
        (position_set_y, pos1, 620),
        (overlay_set_position, "$wc_creator_skill_remaining_label", pos1),
        (overlay_set_color, "$wc_creator_skill_remaining_label", 0xFFDD00),

        # Skill sliders (simplified - just 4 main combat skills)
        # Ironflesh
        (create_text_overlay, reg0, "@Ironflesh:", 0),
        (position_set_x, pos1, 280),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_ironflesh_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_ironflesh_slider", "$wc_creator_skill_ironflesh"),
        (position_set_x, pos1, 370),
        (position_set_y, pos1, 580),
        (overlay_set_position, "$wc_creator_skill_ironflesh_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_ironflesh_slider", pos1),

        # Power Strike
        (create_text_overlay, reg0, "@P.Strike:", 0),
        (position_set_x, pos1, 280),
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_powerstrike_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_powerstrike_slider", "$wc_creator_skill_powerstrike"),
        (position_set_x, pos1, 370),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_creator_skill_powerstrike_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_powerstrike_slider", pos1),

        # Athletics
        (create_text_overlay, reg0, "@Athletics:", 0),
        (position_set_x, pos1, 280),
        (position_set_y, pos1, 510),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_athletics_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_athletics_slider", "$wc_creator_skill_athletics"),
        (position_set_x, pos1, 370),
        (position_set_y, pos1, 510),
        (overlay_set_position, "$wc_creator_skill_athletics_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_athletics_slider", pos1),

        # Shield
        (create_text_overlay, reg0, "@Shield:", 0),
        (position_set_x, pos1, 280),
        (position_set_y, pos1, 475),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_shield_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_shield_slider", "$wc_creator_skill_shield"),
        (position_set_x, pos1, 370),
        (position_set_y, pos1, 475),
        (overlay_set_position, "$wc_creator_skill_shield_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_shield_slider", pos1),

        # More skills on right
        # Riding
        (create_text_overlay, reg0, "@Riding:", 0),
        (position_set_x, pos1, 530),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_riding_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_riding_slider", "$wc_creator_skill_riding"),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 580),
        (overlay_set_position, "$wc_creator_skill_riding_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_riding_slider", pos1),

        # P.Draw
        (create_text_overlay, reg0, "@P.Draw:", 0),
        (position_set_x, pos1, 530),
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_powerdraw_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_powerdraw_slider", "$wc_creator_skill_powerdraw"),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_creator_skill_powerdraw_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_powerdraw_slider", pos1),

        # P.Throw
        (create_text_overlay, reg0, "@P.Throw:", 0),
        (position_set_x, pos1, 530),
        (position_set_y, pos1, 510),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_powerthrow_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_powerthrow_slider", "$wc_creator_skill_powerthrow"),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 510),
        (overlay_set_position, "$wc_creator_skill_powerthrow_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_powerthrow_slider", pos1),

        # W.Master
        (create_text_overlay, reg0, "@W.Master:", 0),
        (position_set_x, pos1, 530),
        (position_set_y, pos1, 475),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_skill_weaponmaster_slider", 0, 10),
        (overlay_set_val, "$wc_creator_skill_weaponmaster_slider", "$wc_creator_skill_weaponmaster"),
        (position_set_x, pos1, 620),
        (position_set_y, pos1, 475),
        (overlay_set_position, "$wc_creator_skill_weaponmaster_slider", pos1),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_skill_weaponmaster_slider", pos1),

        # Proficiencies header
        (create_text_overlay, reg0, "@PROFICIENCIES", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 420),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),

        # 1H Prof
        (create_text_overlay, reg0, "@1H:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 385),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_1h_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_1h_slider", "$wc_creator_prof_1h"),
        (position_set_x, pos1, 90),
        (position_set_y, pos1, 385),
        (overlay_set_position, "$wc_creator_prof_1h_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_1h_slider", pos1),

        # 2H Prof
        (create_text_overlay, reg0, "@2H:", 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 385),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_2h_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_2h_slider", "$wc_creator_prof_2h"),
        (position_set_x, pos1, 240),
        (position_set_y, pos1, 385),
        (overlay_set_position, "$wc_creator_prof_2h_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_2h_slider", pos1),

        # Polearm Prof
        (create_text_overlay, reg0, "@Pole:", 0),
        (position_set_x, pos1, 350),
        (position_set_y, pos1, 385),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_pole_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_pole_slider", "$wc_creator_prof_pole"),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 385),
        (overlay_set_position, "$wc_creator_prof_pole_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_pole_slider", pos1),

        # Archery Prof
        (create_text_overlay, reg0, "@Arch:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 350),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_archery_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_archery_slider", "$wc_creator_prof_archery"),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 350),
        (overlay_set_position, "$wc_creator_prof_archery_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_archery_slider", pos1),

        # Xbow Prof
        (create_text_overlay, reg0, "@XBow:", 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 350),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_xbow_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_xbow_slider", "$wc_creator_prof_xbow"),
        (position_set_x, pos1, 260),
        (position_set_y, pos1, 350),
        (overlay_set_position, "$wc_creator_prof_xbow_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_xbow_slider", pos1),

        # Throwing Prof
        (create_text_overlay, reg0, "@Throw:", 0),
        (position_set_x, pos1, 350),
        (position_set_y, pos1, 350),
        (overlay_set_position, reg0, pos1),
        (create_slider_overlay, "$wc_creator_prof_throw_slider", 0, 400),
        (overlay_set_val, "$wc_creator_prof_throw_slider", "$wc_creator_prof_throw"),
        (position_set_x, pos1, 410),
        (position_set_y, pos1, 350),
        (overlay_set_position, "$wc_creator_prof_throw_slider", pos1),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$wc_creator_prof_throw_slider", pos1),

        # Unit class selector (affects equipment restrictions)
        (create_text_overlay, reg0, "@Unit Class:", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 530),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),

        (create_combo_button_overlay, "$wc_creator_unit_class"),
        (overlay_add_item, "$wc_creator_unit_class", "@Infantry"),
        (overlay_add_item, "$wc_creator_unit_class", "@Archer"),
        (overlay_add_item, "$wc_creator_unit_class", "@Cavalry"),
        (overlay_add_item, "$wc_creator_unit_class", "@Horse Archer"),
        (overlay_set_val, "$wc_creator_unit_class", "$wc_creator_class"),
        (position_set_x, pos1, 650),
        (position_set_y, pos1, 530),
        (overlay_set_position, "$wc_creator_unit_class", pos1),

        # Class description
        (try_begin),
          (eq, "$wc_creator_class", 0),
          (str_store_string, s15, "@(Melee foot - no bows)"),
        (else_try),
          (eq, "$wc_creator_class", 1),
          (str_store_string, s15, "@(Ranged foot - bows OK)"),
        (else_try),
          (eq, "$wc_creator_class", 2),
          (str_store_string, s15, "@(Melee mounted - no bows)"),
        (else_try),
          (str_store_string, s15, "@(Ranged mounted - bows OK)"),
        (try_end),
        (create_text_overlay, reg0, s15, 0),
        (position_set_x, pos1, 550),
        ...
        # Equipment buttons
        (create_text_overlay, reg0, "@EQUIPMENT", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 460),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),

        (create_button_overlay, "$wc_creator_btn_armor", "@Configure Armor...", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 425),
        (overlay_set_position, "$wc_creator_btn_armor", pos1),

        (create_button_overlay, "$wc_creator_btn_loadouts", "@Configure Loadouts...", 0),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 425),
        (overlay_set_position, "$wc_creator_btn_loadouts", pos1),

        (try_begin),
          (this_or_next|eq, "$wc_creator_class", 2),  # Cavalry
          (eq, "$wc_creator_class", 3),                # Horse Archer
          (create_button_overlay, "$wc_creator_btn_horse", "@Configure Horse...", 0),
          (position_set_x, pos1, 850),
          (position_set_y, pos1, 425),
          (overlay_set_position, "$wc_creator_btn_horse", pos1),
        (try_end),

        # Unit name type selector
        (create_text_overlay, reg0, "@Unit Type:", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 380),
        (overlay_set_position, reg0, pos1),

        (create_combo_button_overlay, "$wc_creator_name_type"),
        (overlay_add_item, "$wc_creator_name_type", "@Recruit"),
        (overlay_add_item, "$wc_creator_name_type", "@Footman"),
        (overlay_add_item, "$wc_creator_name_type", "@Soldier"),
        (overlay_add_item, "$wc_creator_name_type", "@Veteran"),
        (overlay_add_item, "$wc_creator_name_type", "@Knight"),
        (overlay_add_item, "$wc_creator_name_type", "@Archer"),
        (overlay_add_item, "$wc_creator_name_type", "@Horseman"),
        (overlay_add_item, "$wc_creator_name_type", "@Guard"),
        (overlay_set_val, "$wc_creator_name_type", "$wc_creator_unit_name_type"),
        (position_set_x, pos1, 650),
        (position_set_y, pos1, 380),
        (overlay_set_position, "$wc_creator_name_type", pos1),

        # Cost Display Section
        (create_text_overlay, reg0, "@ESTIMATED COSTS", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 140),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),

        # Calculate equipment cost from selected items
        (assign, "$wc_preview_equip_cost", 0),
        (try_begin),
          (gt, "$wc_selected_head", 0),
          (item_get_value, ":cost", "$wc_selected_head"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_selected_body", 0),
          (item_get_value, ":cost", "$wc_selected_body"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_selected_foot", 0),
          (item_get_value, ":cost", "$wc_selected_foot"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_selected_hand", 0),
          (item_get_value, ":cost", "$wc_selected_hand"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_selected_horse", 0),
          (item_get_value, ":cost", "$wc_selected_horse"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        # Add loadout 1 weapons
        (try_begin),
          (gt, "$wc_loadout1_slot1", 0),
          (item_get_value, ":cost", "$wc_loadout1_slot1"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_loadout1_slot2", 0),
          (item_get_value, ":cost", "$wc_loadout1_slot2"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_loadout1_slot3", 0),
          (item_get_value, ":cost", "$wc_loadout1_slot3"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),
        (try_begin),
          (gt, "$wc_loadout1_slot4", 0),
          (item_get_value, ":cost", "$wc_loadout1_slot4"),
          (val_add, "$wc_preview_equip_cost", ":cost"),
        (try_end),

        # Calculate weekly maintenance (equip_cost / 100, min 1)
        (store_div, "$wc_preview_maint_cost", "$wc_preview_equip_cost", 100),
        (val_max, "$wc_preview_maint_cost", 1),
        (try_begin),
          (le, "$wc_preview_equip_cost", 0),
          (assign, "$wc_preview_maint_cost", 0),
        (try_end),

        # Display equipment cost
        (assign, reg0, "$wc_preview_equip_cost"),
        (create_text_overlay, "$wc_creator_equip_cost_label", "@Equipment Cost: {reg0} denars", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 110),
        (overlay_set_position, "$wc_creator_equip_cost_label", pos1),

        # Display weekly maintenance
        (assign, reg0, "$wc_preview_maint_cost"),
        (create_text_overlay, "$wc_creator_maint_cost_label", "@Weekly Maintenance: {reg0} denars/unit", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 85),
        (overlay_set_position, "$wc_creator_maint_cost_label", pos1),

        # Bottom buttons
        (create_button_overlay, "$wc_creator_btn_confirm", "@Confirm", tf_center_justify),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_creator_btn_confirm", pos1),

        (create_button_overlay, "$wc_creator_btn_cancel", "@Cancel", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_creator_btn_cancel", pos1),

        (create_button_overlay, "$wc_creator_btn_reset", "@Reset", tf_center_justify),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_creator_btn_reset", pos1),
      ]),
      ...
      (ti_on_presentation_event_state_change, [
        ...
        (try_begin),
          # Mounted toggle
          (eq, ":object", "$wc_creator_mounted_check"),
          (assign, "$wc_creator_is_mounted", ":value"),
        (else_try),
          # Stat sliders
          (eq, ":object", "$wc_creator_str_slider"),
          (assign, "$wc_creator_str", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_agi_slider"),
          (assign, "$wc_creator_agi", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_int_slider"),
          (assign, "$wc_creator_int", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_cha_slider"),
          (assign, "$wc_creator_cha", ":value"),
        (else_try),
          # Skill sliders
          (eq, ":object", "$wc_creator_skill_ironflesh_slider"),
          (assign, "$wc_creator_skill_ironflesh", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_powerstrike_slider"),
          (assign, "$wc_creator_skill_powerstrike", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_athletics_slider"),
          (assign, "$wc_creator_skill_athletics", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_shield_slider"),
          (assign, "$wc_creator_skill_shield", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_riding_slider"),
          (assign, "$wc_creator_skill_riding", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_powerdraw_slider"),
          (assign, "$wc_creator_skill_powerdraw", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_powerthrow_slider"),
          (assign, "$wc_creator_skill_powerthrow", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_skill_weaponmaster_slider"),
          (assign, "$wc_creator_skill_weaponmaster", ":value"),
        (else_try),
          # Prof sliders
          (eq, ":object", "$wc_creator_prof_1h_slider"),
          (assign, "$wc_creator_prof_1h", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_prof_2h_slider"),
          (assign, "$wc_creator_prof_2h", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_prof_pole_slider"),
          (assign, "$wc_creator_prof_pole", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_prof_archery_slider"),
          (assign, "$wc_creator_prof_archery", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_prof_xbow_slider"),
          (assign, "$wc_creator_prof_xbow", ":value"),
        (else_try),
          (eq, ":object", "$wc_creator_prof_throw_slider"),
          (assign, "$wc_creator_prof_throw", ":value"),
        (else_try),
          # Name type
          (eq, ":object", "$wc_creator_name_type"),
          (assign, "$wc_creator_unit_name_type", ":value"),
        (else_try),
          # Unit class selector
          (eq, ":object", "$wc_creator_unit_class"),
          (assign, "$wc_creator_class", ":value"),
          # Auto-set mounted flag based on class
          (try_begin),
            (this_or_next|eq, ":value", 2),  # Cavalry
            (eq, ":value", 3),               # Horse Archer
            (assign, "$wc_creator_is_mounted", 1),
          (else_try),
            (assign, "$wc_creator_is_mounted", 0),
          (try_end),
          # Refresh UI to show/hide horse button
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (else_try),
          # Armor button - opens armor selection menu
          (eq, ":object", "$wc_creator_btn_armor"),
          (start_presentation, "prsnt_wc_armor_selector"),
        (else_try),
          # Loadouts button - opens loadout builder
          (eq, ":object", "$wc_creator_btn_loadouts"),
          (start_presentation, "prsnt_wc_loadout_builder"),
        (else_try),
          # Horse button - opens horse browser (only for mounted units)
          (eq, ":object", "$wc_creator_btn_horse"),
          (assign, "$wc_equip_browser_type", 5),  # 5 = horse
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_equip_browser_selected_item", -1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          # Confirm
          (eq, ":object", "$wc_creator_btn_confirm"),
          # Check if we're in upgrade mode (configuring an upgrade target)
          (try_begin),
            (gt, "$wc_upgrade_target_troop", 0),
            # In upgrade mode - finalize the upgrade configuration
            (call_script, "script_wc_finalize_upgrade_configuration"),
          (else_try),
            # Not in upgrade mode - just validate and show message
            (call_script, "script_wc_validate_unit_configuration"),
            (try_begin),
              (eq, reg0, 1),
              (display_message, "@Configuration valid!"),
            (else_try),
              (display_message, s0),
            (try_end),
          (try_end),
        ...
        (else_try),
          # Cancel
          (eq, ":object", "$wc_creator_btn_cancel"),
          (presentation_set_duration, 0),
        (else_try),
          # Reset
          (eq, ":object", "$wc_creator_btn_reset"),
    ...
    ##  END UNIT CREATOR PRESENTATION  ##

    ##  WARBAND CULTURES: EQUIPMENT BROWSER PRESENTATION  ##
    # Equipment browser for selecting items during unit creation
    # Set $wc_equip_browser_type before starting this presentation:
    #   0=head, 1=body, 2=foot, 3=hand, 4=weapon, 5=horse
    # Returns selected item in $wc_equip_browser_selected_item

    ("wc_equipment_browser", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        # Initialize page and selection
        (try_begin),
          (eq, "$wc_equip_browser_page", 0),
          # First load - initialize
          (assign, "$wc_equip_browser_selected_idx", 0),
        (try_end),

        # Initialize item storage variables (8 items per page)
        (assign, "$wc_equip_item_0", -1),
        (assign, "$wc_equip_item_1", -1),
        (assign, "$wc_equip_item_2", -1),
        (assign, "$wc_equip_item_3", -1),
        (assign, "$wc_equip_item_4", -1),
        (assign, "$wc_equip_item_5", -1),
        (assign, "$wc_equip_item_6", -1),
        (assign, "$wc_equip_item_7", -1),
        (assign, "$wc_equip_total_items", 0),

        # Determine the item type to filter based on equipment browser type
        (assign, ":filter_type", -1),
        (try_begin),
          (eq, "$wc_equip_browser_type", 0),  # Head armor
          (assign, ":filter_type", 0x0c),  # itp_type_head_armor
          (str_store_string, s10, "@HEAD ARMOR"),
        (else_try),
          (eq, "$wc_equip_browser_type", 1),  # Body armor
          (assign, ":filter_type", 0x0d),  # itp_type_body_armor
          (str_store_string, s10, "@BODY ARMOR"),
        (else_try),
          (eq, "$wc_equip_browser_type", 2),  # Foot armor
          (assign, ":filter_type", 0x0e),  # itp_type_foot_armor
          (str_store_string, s10, "@FOOT ARMOR"),
        (else_try),
          (eq, "$wc_equip_browser_type", 3),  # Hand armor
          (assign, ":filter_type", 0x0f),  # itp_type_hand_armor
          (str_store_string, s10, "@HAND ARMOR"),
        (else_try),
          (eq, "$wc_equip_browser_type", 4),  # Weapon (any type)
          (assign, ":filter_type", -2),  # Special: multiple weapon types
          (str_store_string, s10, "@WEAPONS"),
        (else_try),
          (eq, "$wc_equip_browser_type", 5),  # Horse
          (assign, ":filter_type", 0x01),  # itp_type_horse
          (str_store_string, s10, "@HORSES"),
        (try_end),

        # Count matching items and build page data
        (assign, ":item_count", 0),
        (assign, ":page_start", 0),
        (store_mul, ":page_start", "$wc_equip_browser_page", 8),
        (assign, ":page_idx", 0),

        (try_for_range, ":item", 0, 602),  # items up to itm_items_end
          (item_get_type, ":item_type", ":item"),

          # Check if item matches our filter
          (assign, ":matches", 0),
          (try_begin),
            (eq, ":filter_type", -2),  # Weapon filter - match multiple types
            (this_or_next|eq, ":item_type", 0x02),  # one_handed
            (this_or_next|eq, ":item_type", 0x03),  # two_handed
            (this_or_next|eq, ":item_type", 0x04),  # polearm
            (this_or_next|eq, ":item_type", 0x05),  # arrows
            (this_or_next|eq, ":item_type", 0x06),  # bolts
            (this_or_next|eq, ":item_type", 0x07),  # shield
            (this_or_next|eq, ":item_type", 0x08),  # bow
            (this_or_next|eq, ":item_type", 0x09),  # crossbow
            (eq, ":item_type", 0x0a),  # thrown
            (assign, ":matches", 1),
          (else_try),
            (eq, ":item_type", ":filter_type"),
            (assign, ":matches", 1),
          (try_end),

          # ADDITIONAL FILTERING: Tier-gating and class restrictions
          (try_begin),
            (eq, ":matches", 1),

            # Get item value for tier-gating
            (item_get_value, ":item_cost", ":item"),

            # Determine max cost based on unit tier
            (assign, ":max_cost", 99999),
            (try_begin),
              (eq, "$wc_creator_tier", 1),
              (assign, ":max_cost", wc_tier_1_max_armor_cost),  # 300
            (else_try),
              (eq, "$wc_creator_tier", 2),
              (assign, ":max_cost", wc_tier_2_max_armor_cost),  # 1000
            (else_try),
              (eq, "$wc_creator_tier", 3),
              (assign, ":max_cost", wc_tier_3_max_armor_cost),  # 2500
            (else_try),
              (eq, "$wc_creator_tier", 4),
              (assign, ":max_cost", wc_tier_4_max_armor_cost),  # 5000
            (try_end),
            # Tier 5 allows all equipment (99999 default)

            # Apply tier-gating for armor (types 0x0c-0x0f), horses (0x01), and weapons
            (try_begin),
              (this_or_next|eq, ":item_type", 0x0c),  # head armor
              (this_or_next|eq, ":item_type", 0x0d),  # body armor
              (this_or_next|eq, ":item_type", 0x0e),  # foot armor
              (this_or_next|eq, ":item_type", 0x0f),  # hand armor
              (this_or_next|eq, ":item_type", 0x01),  # horse
              (this_or_next|eq, ":item_type", 0x02),  # one_handed
              (this_or_next|eq, ":item_type", 0x03),  # two_handed
              (this_or_next|eq, ":item_type", 0x04),  # polearm
              (this_or_next|eq, ":item_type", 0x07),  # shield
              ...
              (this_or_next|eq, ":item_type", 0x09),  # crossbow
              (eq, ":item_type", 0x0a),  # thrown
              (gt, ":item_cost", ":max_cost"),
              (assign, ":matches", 0),  # Too expensive for this tier
            (try_end),

            # Class restrictions: No bows/crossbows/arrows/bolts for Infantry/Cavalry
            (try_begin),
              (this_or_next|eq, "$wc_creator_class", 0),  # Infantry
              (eq, "$wc_creator_class", 2),  # Cavalry
              (this_or_next|eq, ":item_type", 0x08),  # bow
              (this_or_next|eq, ":item_type", 0x09),  # crossbow
              (this_or_next|eq, ":item_type", 0x05),  # arrows
              (eq, ":item_type", 0x06),  # bolts
              (assign, ":matches", 0),  # Ranged weapons not allowed for non-ranged classes
            (try_end),
          (try_end),

          (try_begin),
            (eq, ":matches", 1),
            # Check if this item is on current page
            (ge, ":item_count", ":page_start"),
            (lt, ":page_idx", 8),
            # Store item at page index
            (try_begin),
              (eq, ":page_idx", 0),
              (assign, "$wc_equip_item_0", ":item"),
            (else_try),
              (eq, ":page_idx", 1),
              (assign, "$wc_equip_item_1", ":item"),
            (else_try),
              (eq, ":page_idx", 2),
              (assign, "$wc_equip_item_2", ":item"),
            (else_try),
              (eq, ":page_idx", 3),
              (assign, "$wc_equip_item_3", ":item"),
            (else_try),
              (eq, ":page_idx", 4),
              (assign, "$wc_equip_item_4", ":item"),
            (else_try),
              (eq, ":page_idx", 5),
              (assign, "$wc_equip_item_5", ":item"),
            (else_try),
              (eq, ":page_idx", 6),
              (assign, "$wc_equip_item_6", ":item"),
            (else_try),
              (eq, ":page_idx", 7),
              (assign, "$wc_equip_item_7", ":item"),
            (try_end),
            (val_add, ":page_idx", 1),
        ...
        (assign, "$wc_equip_total_items", ":item_count"),

        # Calculate total pages
        (store_div, "$wc_equip_total_pages", ":item_count", 8),
        (store_mod, ":remainder", ":item_count", 8),
        (try_begin),
          (gt, ":remainder", 0),
          (val_add, "$wc_equip_total_pages", 1),
        (try_end),
        (val_max, "$wc_equip_total_pages", 1),
        ...
        # Page indicator
        (store_add, reg1, "$wc_equip_browser_page", 1),
        (assign, reg2, "$wc_equip_total_pages"),
        (str_store_string, s11, "@Page {reg1} of {reg2}"),
        (create_text_overlay, reg0, s11, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 640),
        (overlay_set_position, reg0, pos1),

        # Item count display
        (assign, reg3, "$wc_equip_total_items"),
        (str_store_string, s12, "@({reg3} items found)"),
        (create_text_overlay, reg0, s12, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 615),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xAAAAAA),

        # Display items with radio buttons
        (assign, ":y_pos", 560),

        # Item 0
        (try_begin),
          (ge, "$wc_equip_item_0", 0),
          (str_store_item_name, s20, "$wc_equip_item_0"),
          (item_get_value, reg10, "$wc_equip_item_0"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_0"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_0", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_0", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 1
        (try_begin),
          (ge, "$wc_equip_item_1", 0),
          (str_store_item_name, s20, "$wc_equip_item_1"),
          (item_get_value, reg10, "$wc_equip_item_1"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_1"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_1", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_1", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 2
        (try_begin),
          (ge, "$wc_equip_item_2", 0),
          (str_store_item_name, s20, "$wc_equip_item_2"),
          (item_get_value, reg10, "$wc_equip_item_2"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_2"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_2", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_2", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 3
        (try_begin),
          (ge, "$wc_equip_item_3", 0),
          (str_store_item_name, s20, "$wc_equip_item_3"),
          (item_get_value, reg10, "$wc_equip_item_3"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_3"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_3", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_3", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 4
        (try_begin),
          (ge, "$wc_equip_item_4", 0),
          (str_store_item_name, s20, "$wc_equip_item_4"),
          (item_get_value, reg10, "$wc_equip_item_4"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_4"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_4", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_4", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 5
        (try_begin),
          (ge, "$wc_equip_item_5", 0),
          (str_store_item_name, s20, "$wc_equip_item_5"),
          (item_get_value, reg10, "$wc_equip_item_5"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_5"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_5", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_5", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 6
        (try_begin),
          (ge, "$wc_equip_item_6", 0),
          (str_store_item_name, s20, "$wc_equip_item_6"),
          (item_get_value, reg10, "$wc_equip_item_6"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_6"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_6", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_6", pos1),
          (val_sub, ":y_pos", 50),
        (try_end),

        # Item 7
        (try_begin),
          (ge, "$wc_equip_item_7", 0),
          (str_store_item_name, s20, "$wc_equip_item_7"),
          (item_get_value, reg10, "$wc_equip_item_7"),
          (call_script, "script_wc_get_item_stat_string", "$wc_equip_item_7"),
          (str_store_string, s21, "@{s20} - {reg10}d {s0}"),
          (create_button_overlay, "$wc_equip_btn_7", s21, 0),
          (position_set_x, pos1, 150),
          (position_set_y, pos1, ":y_pos"),
          (overlay_set_position, "$wc_equip_btn_7", pos1),
        (try_end),

        # Navigation buttons
        (create_button_overlay, "$wc_equip_btn_prev", "@<< Prev", 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 80),
        (overlay_set_position, "$wc_equip_btn_prev", pos1),

        (create_button_overlay, "$wc_equip_btn_next", "@Next >>", 0),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 80),
        (overlay_set_position, "$wc_equip_btn_next", pos1),

        (create_button_overlay, "$wc_equip_btn_cancel", "@Cancel", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 40),
        (overlay_set_position, "$wc_equip_btn_cancel", pos1),
      ]),

      (ti_on_presentation_event_state_change, [
        (store_trigger_param_1, ":object"),

        # Item buttons - select, store in correct variable, and return to correct presentation
        (try_begin),
          (this_or_next|eq, ":object", "$wc_equip_btn_0"),
          (this_or_next|eq, ":object", "$wc_equip_btn_1"),
          (this_or_next|eq, ":object", "$wc_equip_btn_2"),
          (this_or_next|eq, ":object", "$wc_equip_btn_3"),
          (this_or_next|eq, ":object", "$wc_equip_btn_4"),
          (this_or_next|eq, ":object", "$wc_equip_btn_5"),
          (this_or_next|eq, ":object", "$wc_equip_btn_6"),
          (eq, ":object", "$wc_equip_btn_7"),
          # Determine which item was selected
          (assign, ":selected_item", -1),
          (try_begin),
            (eq, ":object", "$wc_equip_btn_0"),
            (assign, ":selected_item", "$wc_equip_item_0"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_1"),
            (assign, ":selected_item", "$wc_equip_item_1"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_2"),
            (assign, ":selected_item", "$wc_equip_item_2"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_3"),
            (assign, ":selected_item", "$wc_equip_item_3"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_4"),
            (assign, ":selected_item", "$wc_equip_item_4"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_5"),
            (assign, ":selected_item", "$wc_equip_item_5"),
          (else_try),
            (eq, ":object", "$wc_equip_btn_6"),
            (assign, ":selected_item", "$wc_equip_item_6"),
          (else_try),
            (assign, ":selected_item", "$wc_equip_item_7"),
          (try_end),
          # Store item and get return destination
          (call_script, "script_wc_store_selected_equipment", ":selected_item"),
          (str_store_item_name, s0, ":selected_item"),
          (display_message, "@Selected: {s0}"),
          (presentation_set_duration, 0),
          # Return to correct presentation
          (try_begin),
            (eq, reg0, 1),
            (start_presentation, "prsnt_wc_armor_selector"),
          (else_try),
        ...
        (else_try),
          # Previous page
          (eq, ":object", "$wc_equip_btn_prev"),
          (gt, "$wc_equip_browser_page", 0),
          (val_sub, "$wc_equip_browser_page", 1),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          # Next page
          (eq, ":object", "$wc_equip_btn_next"),
          (store_sub, ":max_page", "$wc_equip_total_pages", 1),
          (lt, "$wc_equip_browser_page", ":max_page"),
          (val_add, "$wc_equip_browser_page", 1),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          # Cancel - return to caller
          (eq, ":object", "$wc_equip_btn_cancel"),
          (assign, "$wc_equip_browser_selected_item", -1),
          (presentation_set_duration, 0),
          (try_begin),
            (eq, "$wc_armor_return_to", 1),
            (assign, "$wc_armor_return_to", 0),
            (start_presentation, "prsnt_wc_armor_selector"),
          (else_try),
            (eq, "$wc_loadout_return_to", 1),
            (assign, "$wc_loadout_return_to", 0),
            (start_presentation, "prsnt_wc_loadout_builder"),
          (else_try),
            (start_presentation, "prsnt_wc_unit_creator"),
          (try_end),
    ...
    ##  END EQUIPMENT BROWSER PRESENTATION  ##

    ##  WARBAND CULTURES: ARMOR SELECTOR PRESENTATION  ##
    # Simple menu to select which armor type to browse
    ("wc_armor_selector", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        # Title
        (create_text_overlay, reg0, "@SELECT ARMOR TYPE", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 650),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),
        ...
        # Tier display
        (assign, reg10, "$wc_creator_tier"),
        (str_store_string, s10, "@(Tier {reg10} - equipment filtered by cost)"),
        (create_text_overlay, reg0, s10, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 610),
        (overlay_set_position, reg0, pos1),
        ...
        # Armor type buttons
        (create_button_overlay, "$wc_armor_btn_head", "@Head Armor", tf_center_justify),
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$wc_armor_btn_head", pos1),

        (create_button_overlay, "$wc_armor_btn_body", "@Body Armor", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$wc_armor_btn_body", pos1),

        (create_button_overlay, "$wc_armor_btn_foot", "@Foot Armor", tf_center_justify),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$wc_armor_btn_foot", pos1),

        (create_button_overlay, "$wc_armor_btn_hand", "@Hand Armor", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 430),
        (overlay_set_position, "$wc_armor_btn_hand", pos1),

        # Current selections display
        (create_text_overlay, reg0, "@Current Selections:", 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 350),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xCCCCCC),

        (try_begin),
          (gt, "$wc_selected_head", 0),
          (str_store_item_name, s20, "$wc_selected_head"),
        (else_try),
          (str_store_string, s20, "@(none)"),
        (try_end),
        (str_store_string, s21, "@Head: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 320),
        (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (gt, "$wc_selected_body", 0),
          (str_store_item_name, s20, "$wc_selected_body"),
        (else_try),
          (str_store_string, s20, "@(none)"),
        (try_end),
        (str_store_string, s21, "@Body: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 200),
        ...
        (try_begin),
          (gt, "$wc_selected_foot", 0),
          (str_store_item_name, s20, "$wc_selected_foot"),
        (else_try),
          (str_store_string, s20, "@(none)"),
        (try_end),
        (str_store_string, s21, "@Foot: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 200),
        ...
        (try_begin),
          (gt, "$wc_selected_hand", 0),
          (str_store_item_name, s20, "$wc_selected_hand"),
        (else_try),
          (str_store_string, s20, "@(none)"),
        (try_end),
        (str_store_string, s21, "@Hand: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 200),
        ...
        # Done/Cancel buttons
        (create_button_overlay, "$wc_armor_btn_done", "@Done", tf_center_justify),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_armor_btn_done", pos1),

        (create_button_overlay, "$wc_armor_btn_cancel", "@Cancel", tf_center_justify),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_armor_btn_cancel", pos1),
      ]),
      ...
      (ti_on_presentation_event_state_change, [
        ...
        (try_begin),
          (eq, ":object", "$wc_armor_btn_head"),
          (assign, "$wc_equip_browser_type", 0),  # Head armor
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_armor_return_to", 1),  # Return to armor selector
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_armor_btn_body"),
          (assign, "$wc_equip_browser_type", 1),  # Body armor
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_armor_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_armor_btn_foot"),
          (assign, "$wc_equip_browser_type", 2),  # Foot armor
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_armor_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_armor_btn_hand"),
          (assign, "$wc_equip_browser_type", 3),  # Hand armor
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_armor_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_armor_btn_done"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (else_try),
          (eq, ":object", "$wc_armor_btn_cancel"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (try_end),
      ]),
    ]),
    ##  END ARMOR SELECTOR PRESENTATION  ##

    ##  WARBAND CULTURES: LOADOUT BUILDER PRESENTATION  ##
    # Configure 3 loadouts x 4 weapon slots each
    # Filters weapons by unit class, tier, and mounted status
    ("wc_loadout_builder", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        # Title
        (create_text_overlay, reg0, "@CONFIGURE WEAPON LOADOUTS", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 700),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),
        ...
        (try_begin),
          (eq, "$wc_creator_class", 0),
          (str_store_string, s10, "@Infantry"),
        (else_try),
          (eq, "$wc_creator_class", 1),
          (str_store_string, s10, "@Archer"),
        (else_try),
          (eq, "$wc_creator_class", 2),
          (str_store_string, s10, "@Cavalry"),
        (else_try),
          (str_store_string, s10, "@Horse Archer"),
        (try_end),
        (assign, reg10, "$wc_creator_tier"),
        (str_store_string, s11, "@Class: {s10} | Tier: {reg10}"),
        (create_text_overlay, reg0, s11, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 665),
        (overlay_set_position, reg0, pos1),
        ...
        (try_begin),
          (this_or_next|eq, "$wc_creator_class", 0),  # Infantry
          (eq, "$wc_creator_class", 2),               # Cavalry
          (str_store_string, s12, "@(Bows/crossbows not available for this class)"),
        (else_try),
          (str_store_string, s12, "@(All weapon types available)"),
        (try_end),
        (create_text_overlay, reg0, s12, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 640),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0x666666),

        # LOADOUT 1
        (create_text_overlay, reg0, "@LOADOUT 1:", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),
        ...
        (try_begin),
          (gt, "$wc_loadout1_slot1", 0),
          (str_store_item_name, s20, "$wc_loadout1_slot1"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  1: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_1_1", "@Select", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_loadout_btn_1_1", pos1),

        # L1 Slot 2
        (try_begin),
          (gt, "$wc_loadout1_slot2", 0),
          (str_store_item_name, s20, "$wc_loadout1_slot2"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  2: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 515),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_1_2", "@Select", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 515),
        (overlay_set_position, "$wc_loadout_btn_1_2", pos1),

        # L1 Slot 3
        (try_begin),
          (gt, "$wc_loadout1_slot3", 0),
          (str_store_item_name, s20, "$wc_loadout1_slot3"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  3: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 485),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_1_3", "@Select", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 485),
        (overlay_set_position, "$wc_loadout_btn_1_3", pos1),

        # L1 Slot 4
        (try_begin),
          (gt, "$wc_loadout1_slot4", 0),
          (str_store_item_name, s20, "$wc_loadout1_slot4"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  4: {s20}"),
        (create_text_overlay, reg0, s21, 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 455),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_1_4", "@Select", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 455),
        (overlay_set_position, "$wc_loadout_btn_1_4", pos1),

        # LOADOUT 2
        (create_text_overlay, reg0, "@LOADOUT 2:", 0),
        (position_set_x, pos1, 350),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),

        # L2 slots (similar pattern)
        (try_begin),
          (gt, "$wc_loadout2_slot1", 0),
          (str_store_item_name, s20, "$wc_loadout2_slot1"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  1: {s20}"),
        ...
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_2_1", "@Select", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_loadout_btn_2_1", pos1),

        (try_begin),
          (gt, "$wc_loadout2_slot2", 0),
          (str_store_item_name, s20, "$wc_loadout2_slot2"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  2: {s20}"),
        ...
        (position_set_y, pos1, 515),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_2_2", "@Select", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 515),
        (overlay_set_position, "$wc_loadout_btn_2_2", pos1),

        (try_begin),
          (gt, "$wc_loadout2_slot3", 0),
          (str_store_item_name, s20, "$wc_loadout2_slot3"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  3: {s20}"),
        ...
        (position_set_y, pos1, 485),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_2_3", "@Select", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 485),
        (overlay_set_position, "$wc_loadout_btn_2_3", pos1),

        (try_begin),
          (gt, "$wc_loadout2_slot4", 0),
          (str_store_item_name, s20, "$wc_loadout2_slot4"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  4: {s20}"),
        ...
        (position_set_y, pos1, 455),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_2_4", "@Select", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 455),
        (overlay_set_position, "$wc_loadout_btn_2_4", pos1),

        # LOADOUT 3
        (create_text_overlay, reg0, "@LOADOUT 3:", 0),
        (position_set_x, pos1, 650),
        (position_set_y, pos1, 580),
        (overlay_set_position, reg0, pos1),
        (overlay_set_color, reg0, 0xFFDD00),
        ...
        # L3 slots
        (try_begin),
          (gt, "$wc_loadout3_slot1", 0),
          (str_store_item_name, s20, "$wc_loadout3_slot1"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  1: {s20}"),
        ...
        (position_set_y, pos1, 545),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_3_1", "@Select", 0),
        (position_set_x, pos1, 850),
        (position_set_y, pos1, 545),
        (overlay_set_position, "$wc_loadout_btn_3_1", pos1),

        (try_begin),
          (gt, "$wc_loadout3_slot2", 0),
          (str_store_item_name, s20, "$wc_loadout3_slot2"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  2: {s20}"),
        ...
        (position_set_y, pos1, 515),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_3_2", "@Select", 0),
        (position_set_x, pos1, 850),
        (position_set_y, pos1, 515),
        (overlay_set_position, "$wc_loadout_btn_3_2", pos1),

        (try_begin),
          (gt, "$wc_loadout3_slot3", 0),
          (str_store_item_name, s20, "$wc_loadout3_slot3"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  3: {s20}"),
        ...
        (position_set_y, pos1, 485),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_3_3", "@Select", 0),
        (position_set_x, pos1, 850),
        (position_set_y, pos1, 485),
        (overlay_set_position, "$wc_loadout_btn_3_3", pos1),

        (try_begin),
          (gt, "$wc_loadout3_slot4", 0),
          (str_store_item_name, s20, "$wc_loadout3_slot4"),
        (else_try),
          (str_store_string, s20, "@(empty)"),
        (try_end),
        (str_store_string, s21, "@  4: {s20}"),
        ...
        (position_set_y, pos1, 455),
        (overlay_set_position, reg0, pos1),
        (create_button_overlay, "$wc_loadout_btn_3_4", "@Select", 0),
        (position_set_x, pos1, 850),
        (position_set_y, pos1, 455),
        (overlay_set_position, "$wc_loadout_btn_3_4", pos1),

        # Done/Cancel buttons
        (create_button_overlay, "$wc_loadout_btn_done", "@Done", tf_center_justify),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_loadout_btn_done", pos1),

        (create_button_overlay, "$wc_loadout_btn_cancel", "@Cancel", tf_center_justify),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_loadout_btn_cancel", pos1),
      ]),

      (ti_on_presentation_event_state_change, [
        (store_trigger_param_1, ":object"),

        # Loadout 1 slot buttons
        (try_begin),
          (eq, ":object", "$wc_loadout_btn_1_1"),
          (assign, "$wc_loadout_editing_slot", 11),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_1_2"),
          (assign, "$wc_loadout_editing_slot", 12),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_1_3"),
          (assign, "$wc_loadout_editing_slot", 13),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_1_4"),
          (assign, "$wc_loadout_editing_slot", 14),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        # Loadout 2 slot buttons
        (else_try),
          (eq, ":object", "$wc_loadout_btn_2_1"),
          (assign, "$wc_loadout_editing_slot", 21),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_2_2"),
          (assign, "$wc_loadout_editing_slot", 22),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_2_3"),
          (assign, "$wc_loadout_editing_slot", 23),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_2_4"),
          (assign, "$wc_loadout_editing_slot", 24),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        # Loadout 3 slot buttons
        (else_try),
          (eq, ":object", "$wc_loadout_btn_3_1"),
          (assign, "$wc_loadout_editing_slot", 31),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_3_2"),
          (assign, "$wc_loadout_editing_slot", 32),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_3_3"),
          (assign, "$wc_loadout_editing_slot", 33),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_3_4"),
          (assign, "$wc_loadout_editing_slot", 34),
          (assign, "$wc_equip_browser_type", 4),
          (assign, "$wc_equip_browser_page", 0),
          (assign, "$wc_loadout_return_to", 1),
          (start_presentation, "prsnt_wc_equipment_browser"),
        # Done/Cancel
        (else_try),
          (eq, ":object", "$wc_loadout_btn_done"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (else_try),
          (eq, ":object", "$wc_loadout_btn_cancel"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (try_end),
      ]),
    ]),
    ##  END LOADOUT BUILDER PRESENTATION  ##

    ########################################################
    ##  WARBAND CULTURES: CULTURE TOOL PRESENTATION  #######
    ########################################################
    # Main menu culture configuration tool
    # Allows configuring cultures outside of campaigns
    ("wc_culture_tool", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        (set_fixed_point_multiplier, 1000),

        # Initialize selected culture if not set
        (try_begin),
          (le, "$wc_tool_selected_culture", 0),
          (assign, "$wc_tool_selected_culture", 1),
        (try_end),

        # Title
        (create_text_overlay, reg1, "@Warband Cultures - Culture Configuration Tool", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 700),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 1500),
        ...
        # Instructions
        (create_text_overlay, reg1, "@Configure your custom cultures before starting a new game.", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 660),
        (overlay_set_position, reg1, pos1),
        (overlay_set_color, reg1, 0x888888),

        # Culture Selection header
        (create_text_overlay, reg1, "@SELECT CULTURE", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 600),
        (overlay_set_position, reg1, pos1),
        (overlay_set_color, reg1, 0xFFDD00),

        # Culture buttons (6 base + 4 player)
        (create_button_overlay, "$wc_tool_btn_culture_1", "@Swadian", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_1", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_2", "@Vaegir", 0),
        (position_set_x, pos1, 150),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_2", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_3", "@Khergit", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_3", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_4", "@Nord", 0),
        (position_set_x, pos1, 350),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_4", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_5", "@Rhodok", 0),
        (position_set_x, pos1, 450),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_5", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_6", "@Sarranid", 0),
        (position_set_x, pos1, 550),
        (position_set_y, pos1, 560),
        (overlay_set_position, "$wc_tool_btn_culture_6", pos1),

        # Player cultures row
        (create_button_overlay, "$wc_tool_btn_culture_7", "@Custom 1", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 520),
        (overlay_set_position, "$wc_tool_btn_culture_7", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_8", "@Custom 2", 0),
        (position_set_x, pos1, 150),
        (position_set_y, pos1, 520),
        (overlay_set_position, "$wc_tool_btn_culture_8", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_9", "@Custom 3", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 520),
        (overlay_set_position, "$wc_tool_btn_culture_9", pos1),

        (create_button_overlay, "$wc_tool_btn_culture_10", "@Custom 4", 0),
        (position_set_x, pos1, 350),
        (position_set_y, pos1, 520),
        (overlay_set_position, "$wc_tool_btn_culture_10", pos1),

        # Selected Culture Info
        (create_text_overlay, reg1, "@SELECTED CULTURE INFO", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 460),
        (overlay_set_position, reg1, pos1),
        (overlay_set_color, reg1, 0xFFDD00),

        (assign, reg0, "$wc_tool_selected_culture"),
        (create_text_overlay, "$wc_tool_culture_info", "@Culture {reg0} selected. Units configured: 0/10", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 430),
        (overlay_set_position, "$wc_tool_culture_info", pos1),

        # Culture Actions
        (create_text_overlay, reg1, "@CULTURE ACTIONS", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 370),
        (overlay_set_position, reg1, pos1),
        (overlay_set_color, reg1, 0xFFDD00),

        (create_button_overlay, "$wc_tool_btn_edit_units", "@Edit Unit Tree...", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 335),
        (overlay_set_position, "$wc_tool_btn_edit_units", pos1),

        (create_button_overlay, "$wc_tool_btn_titles", "@Configure Titles...", 0),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 335),
        (overlay_set_position, "$wc_tool_btn_titles", pos1),

        # File Operations
        (create_text_overlay, reg1, "@FILE OPERATIONS", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 270),
        (overlay_set_position, reg1, pos1),
        (overlay_set_color, reg1, 0xFFDD00),

        (create_button_overlay, "$wc_tool_btn_save", "@Save Cultures to File", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 235),
        (overlay_set_position, "$wc_tool_btn_save", pos1),

        (create_button_overlay, "$wc_tool_btn_load", "@Load Cultures from File", 0),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 235),
        (overlay_set_position, "$wc_tool_btn_load", pos1),

        # Status message area
        (create_text_overlay, "$wc_tool_status", "@Ready", 0),
        (position_set_x, pos1, 50),
        (position_set_y, pos1, 180),
        (overlay_set_position, "$wc_tool_status", pos1),
        (overlay_set_color, "$wc_tool_status", 0x00FF00),

        # Bottom buttons
        (create_button_overlay, "$wc_tool_btn_done", "@Done - Return to Main Menu", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 50),
        (overlay_set_position, "$wc_tool_btn_done", pos1),
      ]),

      (ti_on_presentation_event_state_change, [
        (store_trigger_param_1, ":object"),

        # Culture selection buttons
        (try_begin),
          (eq, ":object", "$wc_tool_btn_culture_1"),
          (assign, "$wc_tool_selected_culture", 1),
          (overlay_set_text, "$wc_tool_culture_info", "@Swadian culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_2"),
          (assign, "$wc_tool_selected_culture", 2),
          (overlay_set_text, "$wc_tool_culture_info", "@Vaegir culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_3"),
          (assign, "$wc_tool_selected_culture", 3),
          (overlay_set_text, "$wc_tool_culture_info", "@Khergit culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_4"),
          (assign, "$wc_tool_selected_culture", 4),
          (overlay_set_text, "$wc_tool_culture_info", "@Nord culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_5"),
          (assign, "$wc_tool_selected_culture", 5),
          (overlay_set_text, "$wc_tool_culture_info", "@Rhodok culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_6"),
          (assign, "$wc_tool_selected_culture", 6),
          (overlay_set_text, "$wc_tool_culture_info", "@Sarranid culture selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_7"),
          (assign, "$wc_tool_selected_culture", 7),
          (overlay_set_text, "$wc_tool_culture_info", "@Custom Culture 1 selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_8"),
          (assign, "$wc_tool_selected_culture", 8),
          (overlay_set_text, "$wc_tool_culture_info", "@Custom Culture 2 selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_9"),
          (assign, "$wc_tool_selected_culture", 9),
          (overlay_set_text, "$wc_tool_culture_info", "@Custom Culture 3 selected"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_culture_10"),
          (assign, "$wc_tool_selected_culture", 10),
          (overlay_set_text, "$wc_tool_culture_info", "@Custom Culture 4 selected"),
        # Action buttons
        (else_try),
          (eq, ":object", "$wc_tool_btn_edit_units"),
          # Set up unit creator for selected culture
          (store_add, ":culture_fac", "$wc_tool_selected_culture", "fac_culture_1"),
          (val_sub, ":culture_fac", 1),
          (assign, "$wc_creator_culture", ":culture_fac"),
          (assign, "$wc_creator_tier", 1),
          # Reset creator variables
          (assign, "$wc_creator_str", 0),
          (start_presentation, "prsnt_wc_unit_creator"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_titles"),
          (start_presentation, "prsnt_wc_title_config"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_save"),
          (call_script, "script_wc_save_cultures_to_file"),
          (overlay_set_text, "$wc_tool_status", "@Cultures saved to Data/wc_cultures.txt"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_load"),
          (call_script, "script_wc_load_cultures_from_file"),
          (overlay_set_text, "$wc_tool_status", "@Cultures loaded from Data/wc_cultures.txt"),
        (else_try),
          (eq, ":object", "$wc_tool_btn_done"),
          (presentation_set_duration, 0),
          (jump_to_menu, "mnu_start_game_0"),
        (try_end),
      ]),
    ]),
    ##  END CULTURE TOOL PRESENTATION  ##

    ########################################################
    ##  WARBAND CULTURES: TITLE CONFIGURATION PRESENTATION ##
    ########################################################
    # Configure ruler/lord titles for custom cultures
    ("wc_title_config", 0, mesh_load_window, [
      (ti_on_presentation_load, [
        (set_fixed_point_multiplier, 1000),

        # Title
        (create_text_overlay, reg1, "@Configure Titles - Custom Culture", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 700),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 1500),
        ...
        # King title
        (create_text_overlay, reg1, "@Ruler Title:", 0),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 550),
        (overlay_set_position, reg1, pos1),

        (create_combo_button_overlay, "$wc_title_ruler_combo"),
        (overlay_add_item, "$wc_title_ruler_combo", "@King"),
        (overlay_add_item, "$wc_title_ruler_combo", "@Khan"),
        (overlay_add_item, "$wc_title_ruler_combo", "@Sultan"),
        (overlay_add_item, "$wc_title_ruler_combo", "@Emperor"),
        (overlay_add_item, "$wc_title_ruler_combo", "@High King"),
        (overlay_add_item, "$wc_title_ruler_combo", "@Tsar"),
        (overlay_set_val, "$wc_title_ruler_combo", "$wc_custom_ruler_title"),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 550),
        (overlay_set_position, "$wc_title_ruler_combo", pos1),

        # Lord title
        (create_text_overlay, reg1, "@Lord Title:", 0),
        (position_set_x, pos1, 100),
        (position_set_y, pos1, 500),
        (overlay_set_position, reg1, pos1),

        (create_combo_button_overlay, "$wc_title_lord_combo"),
        (overlay_add_item, "$wc_title_lord_combo", "@Lord"),
        (overlay_add_item, "$wc_title_lord_combo", "@Jarl"),
        (overlay_add_item, "$wc_title_lord_combo", "@Emir"),
        (overlay_add_item, "$wc_title_lord_combo", "@Duke"),
        (overlay_add_item, "$wc_title_lord_combo", "@Count"),
        (overlay_add_item, "$wc_title_lord_combo", "@Boyar"),
        (overlay_set_val, "$wc_title_lord_combo", "$wc_custom_lord_title"),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$wc_title_lord_combo", pos1),

        # Bottom buttons
        (create_button_overlay, "$wc_title_btn_done", "@Done", tf_center_justify),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_title_btn_done", pos1),

        (create_button_overlay, "$wc_title_btn_cancel", "@Cancel", tf_center_justify),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 100),
        (overlay_set_position, "$wc_title_btn_cancel", pos1),
      ]),
      ...
      (ti_on_presentation_event_state_change, [
        ...
        (try_begin),
          (eq, ":object", "$wc_title_ruler_combo"),
          (assign, "$wc_custom_ruler_title", ":value"),
        (else_try),
          (eq, ":object", "$wc_title_lord_combo"),
          (assign, "$wc_custom_lord_title", ":value"),
        (else_try),
          (eq, ":object", "$wc_title_btn_done"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_culture_tool"),
        (else_try),
          (eq, ":object", "$wc_title_btn_cancel"),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_wc_culture_tool"),
        (try_end),
      ]),
    ]),
    ##  END TITLE CONFIGURATION PRESENTATION  ##
